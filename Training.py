...
if __name__ == "__main__":
    ...
    model_name = r'D:\ahmed fiver\face detction new model\Face Detection.v24-resize416x416-aug3x-traintestsplitonly.yolov8\yolov8n.pt'  # Path to YOLOv8n model
    ...
    results = model.train(
        data=r'D:\ahmed fiver\face detction new model\Face Detection.v24-resize416x416-aug3x-traintestsplitonly.yolov8\data.yaml',  # Path to the YAML file
        epochs=200,               # Increased number of epochs for better training
        imgsz=640,                # Image size
        batch=8,                  # Increased batch size if GPU allows
        name='face_reidentification',    # Save name for the run
    ...
    model.save('face_reidentification_model.pt')
    ...
    print("tensorboard --logdir training_results/face_reidentification")
